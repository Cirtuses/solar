...
def calculate_dni_from_onefile(file_path, save_flag=False):  # 从最原始的辐射计测量出的文件中计算dni
    GHI = 'total_Avg' 
    DHI = 'diffuse_Avg'
    TIME = 'TMSTAMP'
...
def calculate_dni_from_GHI_DHI(time, ghi, dhi): 
...
def main():
    ...
    test_time = '2022/12/13 12:47:25'
    # calculate_dni_from_GHI_DHI(time, ghi, dhi)
    dni = calculate_dni_from_GHI_DHI(test_time, 433, 326)
    print(dni)
